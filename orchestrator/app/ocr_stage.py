...
def run_ocr_stage(
    ...
    vision_crops = [
        {**crop, "status": "pending"}
        for crop in iter_page_crops(layout_asset_pages)
        if is_vision_crop(crop)
    ]
    ...
    vision_manifest_path = write_vision_pending_manifest(
        job_id=job_id,
        paths=paths,
        meta=meta,
        trace=trace,
    ...
    manifest = {
        ...
        "artifacts": {
            ...
            "vision_pending": vision_manifest_path,
        },
